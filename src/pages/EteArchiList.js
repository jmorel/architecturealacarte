...
export class EteArchiListContainer extends React.Component {
    state = {
        locations: []
    }
    ...
    render() {
        return (
            <EteArchiList locations={this.state.locations} history={this.props.history} />
        );
    }
}

export function EteArchiList({locations, history}) {
